...
<body class="login-bg">
<%=basePath%>common/image/login-bg-<%=new Random().nextInt(8)%>.jpg
<div class="login-box">
    <header>
        <h1>仓库进销存台管理系统</h1>
    </header>
    <div class="login-main">
        <form action="validateUser.action" class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                ...
                <input type="text" name="tUserCustom.username" lay-verify="userName" autocomplete="off"
            ...
            <div class="layui-form-item">
                ...
                <input type="password" name="tUserCustom.password" lay-verify="password" autocomplete="off"
